...
#define CYBLE_TROUGHPUT_SERVICE_CUSTOM_CHARACTERISTIC_CHAR_INDEX   (0x00u) /* Index of Custom Characteristic characteristic */
#define CYBLE_TROUGHPUT_SERVICE_CUSTOM_CHARACTERISTIC_CLIENT_CHARACTERISTIC_CONFIGURATION_DESC_INDEX   (0x00u) /* Index of Client Characteristic Configuration descriptor */
#define CYBLE_TROUGHPUT_SERVICE_SPEEDTEST_CHAR_INDEX   (0x01u) /* Index of SpeedTest characteristic */
